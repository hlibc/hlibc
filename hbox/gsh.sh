...
dd if=/dev/urandom of=logs/gshtest bs=1 count=1000000

dd if=/dev/urandom of=logs/gshtest2 bs=1 count=1000000

dd if=/dev/urandom of=logs/gshtest3 bs=1 count=1000000
